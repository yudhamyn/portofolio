<template>
  <main class="mt-10 md:mt-1 flex flex-col-reverse gap-8 items-center md:flex-row md:gap-16 md:justify-center min-h-[65vh] md:min-h-[80vh]">
    ...
    <div class="flex justify-center md:justify-start fadein-right">
      <img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1" class="w-10/12 md:h-auto rounded-full border-4 border-blue-200 pict" src="/img/yudha.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Data Scientist ", "Data Analyst ", "ML Engineer ", "Web Developer ", "Freelancer"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
